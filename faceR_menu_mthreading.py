...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # creating threads
        self.t1 = threading.Thread(target=main_faceR.faceR, args=(5,))
        self.t2 = threading.Thread(target=main_faceR.faceR, args=(0,))
        self.t3 = threading.Thread(target=main_faceR.faceR)
        # self.t2 = threading.Thread(target = self.mainloop())
